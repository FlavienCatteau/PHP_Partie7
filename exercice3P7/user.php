...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice3P7user</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 3 partie 7</h1>
                <p class="lead text-center">Avec le formulaire de l'exercice 1, afficher dans la page user.php les données du formulaire transmis.</p>
            </div>
