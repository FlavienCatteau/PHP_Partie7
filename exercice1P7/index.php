...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice1P7</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 1 partie 7</h1>
                <p class="lead text-center">Créer un formulaire demandant le nom et le prénom. Ce formulaire doit rediriger vers la page user.php avec la méthode GET.</p>
            </div>
        ...
        <main>
                ...
                <form method="GET" action="user.php" class="text-center">
