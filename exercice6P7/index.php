...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice6P7</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 6 partie 7</h1>
                <p class="lead text-center">Avec le formulaire de l'exercice 5, Si des données sont passées en POST ou en GET, le formulaire ne doit pas être affiché. </p>
